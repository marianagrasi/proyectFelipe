          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                echo '<div class="theme-logo-wrap">'
                        . '<div class="theme-logo">'
                        . '<strong>Dental</strong>Care</div>'
                        . '</div>';
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) . '">';
                  ...
                  echo '<button type="submit" class="option-tree-ui-button button button-secondary left reset-settings" title="' . esc_html__( 'Reset Options', 'dental-care' ) . '">' . esc_html__( 'Reset Options', 'dental-care' ) . '</button>';
