...
class TeamCategorySelect_Control extends Base_Data_Control {

    const TeamCategorySelect = 'team_category_select';

    /**
     * Set control type.
     */
    public function get_type() {
        return self::TeamCategorySelect;
    }
    ...
    protected function get_default_settings() {
        return [
            'optionscat' => self::get_team_categories(),
            'include' => '',
            'exclude' => '',
        ];
    }
