...
class ProductCategorySelect_Control extends Base_Data_Control {

    const ProductCategorySelect = 'product_category_select';

    /**
     * Set control type.
     */
    public function get_type() {
        return self::ProductCategorySelect;
    }
    ...
    protected function get_default_settings() {
        return [
            'optionscat' => self::get_product_categories(),
            'include' => '',
            'exclude' => '',
        ];
    }
