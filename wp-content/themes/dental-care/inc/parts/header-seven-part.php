        ...
        <div class="contact-header-area">
            <div class="container">
                <div class="row contact-details-row">
                    ...
                    <?php
                    if (class_exists('OT_Loader')) {
                        if (ot_get_option('address_text') != "" || ot_get_option('address_details') != "") {
                            ?>
                            <div class="address-item-wrapper">
                                <div class="icon-wrapper">
                                    <?php
                                    if (ot_get_option('address_icon') == "") {
                                        ?>
                                        <i class="lnr lnr-map-marker"></i>
                                        <?php
                                    } else {
                                        ?>
                                        <i class="<?php echo esc_attr(ot_get_option('address_icon')); ?>"></i>
                                        <?php
                                    }
                                    ?>
                                ...
                                <div class="header-area-contact-info">
                                    <h6><?php echo wp_kses(ot_get_option('address_text'), $allowed_html); ?></h6>
                                    <p><?php echo wp_kses(ot_get_option('address_details'), $allowed_html); ?></p>
                                </div>
                            </div>
                            <?php
                        }
                    ...
                    <?php
                    if (class_exists('OT_Loader')) {
                        if (ot_get_option('email_text') != "" || ot_get_option('email_details') != "") {
                            ?>
                            <div class="email-item-wrapper">
                                <div class="icon-wrapper">
                                    <?php
                                    if (ot_get_option('email_icon') == "") {
                                        ?>
                                        <i class="lnr lnr-envelope"></i>
                                        <?php
                                    } else {
                                        ?>
                                        <i class="<?php echo esc_attr(ot_get_option('email_icon')); ?>"></i>
                                        <?php
                                    }
                                    ?>
                                ...
                                <div class="header-area-contact-info">
                                    <h6><?php echo wp_kses(ot_get_option('email_text'), $allowed_html); ?></h6>
                                    <p><?php echo wp_kses(ot_get_option('email_details'), $allowed_html); ?></p>
                                </div>
                            </div>
                            <?php
                        }
                    ...
                    if (class_exists('OT_Loader')) {
                        ...
                        if (ot_get_option('book_link') != "" || ot_get_option('contact_book_text') != "") {
                            ?>
