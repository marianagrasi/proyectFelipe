...
<div class="header-fourteen container-fluid">
            ...
            <div class="row">
                ...
                if (class_exists('OT_Loader')) {
                    if (ot_get_option('opening_hours_text') != "" || ot_get_option('contact_hours') != "") {
                        ?>
                        <div class="opening-hours-item-wrapper col-md-3 col-sm-3 col-xs-3 header-contact-info">
                ...
                if (class_exists('OT_Loader')) {
                    if (ot_get_option('call_us_text') != "" || ot_get_option('contact_number') != "") {
                        ?>
                        <div class="call-contact-wrapper col-md-3 col-sm-3 col-xs-3 header-contact-info">
                            <div class="icon-wrapper">
                                <?php
                ...
                if($book_link_target == 'new-window'){
                    ...
                    if (ot_get_option('contact_book_text') != "") { ?>
                        <div class="appointment-booking-wrapper col-md-3 col-sm-3 col-xs-3 header-contact-info">
                            <div class="icon-wrapper">
                                <?php
