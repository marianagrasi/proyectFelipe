...
<div class="author-box media col-md-12">
    <a href="<?php echo esc_url($dental_care_author_link); ?>" class="author-img pull-left">
        <?php echo get_avatar($dental_care_author_mail, '90'); ?>
    </a>
    <div class="media-body">
        <h5 class="media-heading author-name"><a href="<?php echo esc_url($dental_care_author_link); ?>"><?php echo esc_html($dental_care_author_name); ?></a> </h5>
