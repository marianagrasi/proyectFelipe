...
<header class="masthead container-fluid header-thirteen header-fifteen header-sixteen header-seventeen">
    <div class="container">
                ...
                if ((ot_get_option('call_us_text') != "") || (ot_get_option('contact_number') != "")) { ?>
                    <div class="call-us-contact contact-icon">
                        ...
                        <div class="header-nine-contact-info">
                            <?php echo wp_kses(ot_get_option('contact_number'), $allowed_html); ?>
                        </div>
