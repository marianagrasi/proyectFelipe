<?php
/**
 * Template Name: Grid Blog Page
 * Displays blog grid page
 *
 * @package Dental_Care
 */
$orig_post = $post;
    ...
    <div class="row">
        <div id="primary" class="content-area  <?php echo esc_attr($dental_care_cols_main); ?>">
            <main id="main" class="site-main">
                ...
                <div class="row dental-care-blog-grid">
                    <?php
                    while ($wp_query->have_posts()) : $wp_query->the_post();
                        ...
                        if ($post_counter == 3) {
                            echo '</div>';
                            echo '<div class="row dental-care-blog-grid">';
                            $post_counter = 0;
                        }
                    endwhile;
                    ?>
                ...
                <nav class="navigation posts-navigation">
                    ...
                    <div class="nav-links">
                        <div class="nav-next"><?php next_posts_link('Older Entries', 'dental-care') ?></div>
                        <div class="nav-previous"><?php previous_posts_link('Newer Entries ', 'dental-care') ?></div>            
                    </div><!-- .nav-links -->
                </nav><!-- .navigation -->
            </main><!-- #main -->
        </div><!-- #primary -->
